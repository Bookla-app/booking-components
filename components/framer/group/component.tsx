...
// GroupPicker Component (Participants Picker)
...
const GroupPicker: React.FC<GroupPickerProps> = ({
    ...
    const [participants, setParticipants] = useState<number>(minParticipants)
...
function GroupBookingComponent(props: GroupBookingProps) {
    ...
    }, [selectedResourceID, currentParticipants, serviceLoaded])
    ...
    const loadServiceData = async () => {
        ...
        try {
            ...
            // Check if service type is group
            if (response.type && response.type !== "group") {
                setError(
                    `This component only supports group services. Service type '${response.type}' is not supported.`
                )
                setServiceLoaded(false)
                return
            }
...
GroupBookingComponent.propertyControls = {
    size: {
